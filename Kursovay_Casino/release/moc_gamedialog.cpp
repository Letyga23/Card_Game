...
QT_MOC_LITERAL(1, 11, 12), // "gameSelected"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8), // "gameName"
...
QT_MOC_LITERAL(6, 80, 23) // "on_pushButton_3_clicked"
    ...
    "GameDialog\0gameSelected\0\0gameName\0"
...
void GameDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gameSelected((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameDialog::gameSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameDialog::gameSelected(const QString & _t1)
{
